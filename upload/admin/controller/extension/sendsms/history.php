<?php
class ControllerExtensionSendSMSHistory extends Controller {
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'], true)
        );
        ...
        $data['sort_status'] = $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, true);
        $data['sort_message'] = $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=message' . $url, true);
        $data['sort_details'] = $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=details' . $url, true);
        $data['sort_content'] = $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=content' . $url, true);
        $data['sort_type'] = $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=type' . $url, true);
        $data['sort_sent_on'] = $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=sent_on' . $url, true);
        $data['sort_phone'] = $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=phone' . $url, true);
        ...
        $pagination->url = $this->url->link('extension/sendsms/history', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('extension/sendsms/history', $data));
    }
}
